...
static char *defstr[]={
    "This is a tricky video driver, for speedup. Only every two lines will be converted. With new digitized palette. Converted by ImageStudio.",
